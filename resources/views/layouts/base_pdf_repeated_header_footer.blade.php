 ...
 <head>
     ...
     <style>
         ...
         * {
         ...
         /* garante que o thead seja sempre repetido nas páginas */
         table thead { display: table-header-group; }
         /* garante que o tfoot seja sempre repetido nas páginas */
         table tfoot { display: table-footer-group; }

         /* evita quebra interna de cada item */
         .service-item {
             page-break-inside: avoid;
             /* para navegadores mais antigos também: */
