...
@section('content')
    <div style="padding:10px;">
            ...
            <table style="border: 1px solid #ddd;width:100%;border-collapse: collapse;border-top: none!important;border-bottom:none!important;">
                <tr>
                    <td style="padding:20px;">
                    ...
                    <td style="padding:10px;" align="center">
                        ...
                        @if (isset($order_service->type_airworthiness) && !is_null($order_service->type_airworthiness))
                            @if ($order_service->type_airworthiness == 'airworthy')
                                ...
                                realizados de acordo com os Dados Técnicos e os Regulamentos aplicáveis e que após a inspeção de
